...
optirun python shrink.py --network vgg --dataset traffic --size 100
optirun python shrink.py --network vgg --dataset cifar10 --size 100
optirun python shrink.py --network resnet --dataset traffic --size 100
optirun python shrink.py --network resnet --dataset cifar10 --size 100
optirun python shrink.py --network inception --dataset traffic --size 100
optirun python shrink.py --network inception --dataset cifar10 --size 100